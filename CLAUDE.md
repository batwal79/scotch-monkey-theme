...
This project is part of the Cowork-Projects monorepo which has been graphed with Graphify.
- Graph output: `C:\Users\Bobby\Documents\Cowork-Projects\graphify-out\GRAPH_REPORT.md`
- Before answering architecture, dependency, or "where does X live" questions, consult the graph first.
- Use `graph.json` for targeted node/edge queries via Claude Code's graphify skill.
